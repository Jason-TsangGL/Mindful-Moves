...
//    var latestHeartRate = HealthStore.latestHeartRate(HealthStore.init())
//    var HRUpdate : HKSampleQuery
...
//                    let GetLatestHr = data.quantity.doubleValue(for: unit)
    ...
    override func reloadData() {
        DispatchQueue.main.async {
            ...
            let sampleStartDates = self.dataValues.map { $0.endDate }
