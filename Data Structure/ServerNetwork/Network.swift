...
class Network {
    let database = CKContainer(identifier: "iCloud.NetworkTest1").publicCloudDatabase
//    func savedata() async  {
//        let DataRecord = CKRecord(recordType: "MobilityItems")
//        do {
//            try  await database.save(DataRecord)
//  
//        } catch _ {
//            
//        }
